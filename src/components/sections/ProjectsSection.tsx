...
// Shown when no thumbnail image exists yet
    ...
    <section className="py-24 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-20"
        >
          <motion.p variants={fadeInUp} className="text-xs text-violet-400 font-mono uppercase tracking-widest mb-3">
            Selected Work
          </motion.p>
          ...
          <motion.p variants={fadeInUp} className="text-slate-500 mt-3 max-w-md">
            A mix of backend systems, tools, and interfaces I'm proud of.
          </motion.p>
        </motion.div>
          ...
          {projects.map((p, i) => {
            ...
            return (
              <motion.div
                ...
                className="group relative rounded-2xl border border-white/[0.07] bg-[#111627]/60 backdrop-blur-sm overflow-hidden transition-all duration-300 hover:border-white/[0.12]"
                style={{
              ...
              >
                ...
                <div className={`relative z-10 grid grid-cols-1 lg:grid-cols-2 ${isEven ? "" : "lg:grid-flow-col-dense"}`}>
                  ...
                  {/* ── THUMBNAIL SIDE ── */}
                  <div className={`relative aspect-[16/10] lg:aspect-auto min-h-[240px] overflow-hidden ${isEven ? "lg:border-l border-white/[0.06]" : "lg:border-r border-white/[0.06] lg:col-start-1 lg:row-start-1"}`}>
                    {p.thumbnail ? (
                      <Image
                        src={p.thumbnail}
                    ...
                    <div
                      className={`absolute inset-0 pointer-events-none ${
                        isEven
                          ? "bg-gradient-to-r from-[#111627] via-transparent to-transparent lg:from-[#111627]/80"
                          : "bg-gradient-to-l from-[#111627] via-transparent to-transparent lg:from-[#111627]/80"
                      }`}
                    />

                    {/* Top-right corner: live badge if available */}
                    {p.live !== "#" && (
